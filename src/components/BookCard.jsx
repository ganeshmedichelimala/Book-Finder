...
export default function BookCard({ book }) {
  ...
  return (
    <a href={href} target="_blank" rel="noreferrer" className="card p-3 hover:ring-2 hover:ring-brand-500 transition block">
      ...
      <div className="space-y-1">
        ...
        {book.previewLink && <div className="text-xs text-brand-400">Preview ↗</div>}
      </div>
    </a>
  )
}
